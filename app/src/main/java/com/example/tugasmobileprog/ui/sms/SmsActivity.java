package com.example.tugasmobileprog.ui.sms;
...
import com.example.tugasmobileprog.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPhoneNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent("com.example.tugasmobileprog.VIEWCONTACT"));
            }
        });
